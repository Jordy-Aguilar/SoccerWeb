...
namespace SoccerWeb.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public ClubsController(SoccerWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Liga")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Liga")] Club club)
        {
            if (id != club.Id)
            {
                return NotFound();
